...
export const STRINGS = {
  da: {
    ...
    loginGateTitle: "Log ind for at fortsætte",
    loginGateIntro: "Log ind med jeres e-mail og adgangskode. Har I ikke en konto endnu, kan I oprette en herunder.",
    signInBtn: "Log ind",
    signUpBtn: "Opret ny konto",
    ...
    resetGateIntro: "Indtast jeres e-mail, så sender vi en kode til at nulstille adgangskoden.",
    sendResetCode: "Send nulstillings-kode",
    resetCodeSentTo: (email) => `Vi har sendt en kode til ${email}. Indtast den herunder sammen med en ny adgangskode.`,
  ...
  en: {
    ...
    loginGateIntro: "Sign in with your email and password. Don't have an account yet? Create one below.",
    signInBtn: "Sign in",
    ...
    resetGateIntro: "Enter your email and we'll send you a code to reset your password.",
    sendResetCode: "Send reset code",
    resetCodeSentTo: (email) => `We've sent a code to ${email}. Enter it below along with a new password.`,

...
export const STRINGS = {
  da: {
    ...
    emailLinkSent: "Tjek din indbakke for et login-link",
    emailLinkFailed: "Kunne ikke sende linket. Prøv igen.",
  ...
  en: {
    ...
    emailLinkSent: "Check your inbox for a sign-in link",
    emailLinkFailed: "Couldn't send the link. Try again.",

...
export const STRINGS = {
  da: {
    ...
    loginGateIntro: "Indtast jeres e-mail, så sender vi en kode. Har I ikke en konto endnu, opretter vi en med det samme.",
  ...
  en: {
    ...
    loginGateIntro: "Enter your email and we'll send you a code. Don't have an account yet? We'll create one right away.",
